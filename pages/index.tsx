...
const name = "Teman Dalam Perjalanan";
const Bio1 = "❝ Layanan Bimbingan Konseling ❞";
            ...
            <div className="relative mb-6 flex w-full flex-col justify-center bg-opacity-90 px-2 sm:min-h-full sm:rounded-lg sm:px-6">
              <div className="flex flex-col items-center justify-center rounded-md p-2 py-4">
                ...
                <div className="mt-3">
                  ...
                  <a
                      href="https://www.instagram.com/fh.unesa"
                      target="_blank"
                    ...
                    <a href="https://www.tiktok.com/@temandalamperjalanan.fh" target="_blank" rel="noopener noreferrer">
            ...
            <footer>
              <div className="container mx-auto text-center">
                ...
                <p className="text-gray text-s">
                  © {new Date().getFullYear()} Teman Dalam Perjalanan. All rights reserved.
                </p>
              </div>
            </footer>
          </div>
